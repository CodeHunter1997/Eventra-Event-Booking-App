...
class DeleteActivity : AppCompatActivity() {
    ...
    private val TAG = "DeleteActivity"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val emailEditText = findViewById<EditText>(R.id.et_date)
        ...
        deleteButton.setOnClickListener {
            ...
            if (emailInput.isEmpty()) {
                ...
                startActivity(Intent(this@DeleteActivity, UserLogin::class.java))
                finish()
            } else {
    ...
    private fun deleteAccount(email: String, token: String) {
        ...
        ApiClient.instance.deleteAccount(token, requestBody).enqueue(object : Callback<DeleteAccountResponse> {
            override fun onResponse(call: Call<DeleteAccountResponse>, response: Response<DeleteAccountResponse>) {
                if (response.isSuccessful) {
                    Toast.makeText(this@DeleteActivity, response.body()?.message ?: "Account deleted successfully!", Toast.LENGTH_LONG).show()
                    ...
                    Toast.makeText(this@DeleteActivity, "Account deletion failed: ${response.code()} - ${errorBody}", Toast.LENGTH_LONG).show()
                }
            }
            ...
            override fun onFailure(call: Call<DeleteAccountResponse>, t: Throwable) {
                ...
                Toast.makeText(this@DeleteActivity, "Error deleting account: ${t.localizedMessage}", Toast.LENGTH_LONG).show()
            }
        })
    }
}
